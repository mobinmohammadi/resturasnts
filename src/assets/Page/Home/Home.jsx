        ...
        <div className="w-[90%] mx-auto flex flex-col gap-10">
          <div className="relative">
            <div className="flex flex-col gap-2  justify-center items-center pt-5 pb-3 border-b-2 border-sky-600 border-solid ">
              ...
              <div onClick={() => hiddenShowAddreas()} className="w-full bg-sky-500 flex justify-center items-center rounded-md cursor-pointer hover:bg-sky-600 transition-all  pt-2 pb-2">
